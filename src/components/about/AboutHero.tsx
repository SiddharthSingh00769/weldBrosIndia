...
export function AboutHero() {
  ...
  return (
    <section className="relative isolate h-[100dvh] min-h-[640px] overflow-hidden bg-[#07111d] text-white lg:h-[100dvh] lg:min-h-[720px] lg:max-h-[900px]">
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 scale-[1.03] bg-[url('/images/about/about-hero.jpg')] bg-cover bg-center"
      />
      ...
      >
        ...
        >
          ...
          >
            WBRS Industries is focused on transformer tank manufacturing and
