...
export function QuoteHero() {
  ...
  return (
    <section className="relative isolate h-[100dvh] min-h-[640px] overflow-hidden bg-[#07111d] text-white lg:h-[100dvh] lg:min-h-[720px] lg:max-h-[900px]">
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 scale-[1.03] bg-[url('/images/request-quote/quote-hero.jpg')] bg-cover bg-center"
      />

      {/* Industrial Tint */}
      <div
        aria-hidden="true"
        className="absolute inset-0 bg-[#07111d]/50"
      />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, rgba(7,17,29,0.72) 0%, rgba(7,17,29,0.10) 45%, rgba(7,17,29,0.30) 100%)",
        }}
      />
      ...
      <Container className="relative z-10 flex h-full w-full flex-col justify-end pb-8 pt-28 sm:pb-10 sm:pt-32 lg:pb-12 xl:pb-14">
        ...
        >
          ...
          >
            Share your transformer tank or fabricated component requirement
            with our team. Include your specifications or drawings for a more
            accurate response.
          </p>
