...
export function QuoteForm() {
  ...
  if (submitted) {
    return (
      <section className="bg-[#f7f8f9] py-24 md:py-32 lg:py-40">
        <Container>
          <div className="mx-auto max-w-3xl border border-[#dde2e6] bg-white px-6 py-16 text-center md:px-12 md:py-20">
            ...
            <h2 className="mt-4 font-heading text-[clamp(2.2rem,4vw,3.5rem)] font-semibold leading-[0.96] tracking-[-0.045em] text-[#17212b]">
              Thank you for contacting WBRS Industries.
            </h2>

            <p className="mx-auto mt-6 max-w-xl text-base leading-7 text-[#5f6b75] md:text-lg md:leading-8">
              Your requirement has been submitted to our team. We will review
              the information provided and get back to you regarding your
              enquiry.
            </p>
      ...
      <Container>
        <div className="grid gap-12 lg:grid-cols-[0.65fr_1.35fr] lg:gap-20 xl:gap-28">
          ...
          <form
            ...
            className="border border-[#dde2e6] bg-white p-5 sm:p-7 md:p-9 lg:p-10"
          >
            {/* Contact Information */}
            <div>
              ...
              <div className="mt-6 space-y-5">
                ...
                >
                  <textarea
                    ...
                    className={textareaClass(Boolean(errors.dimensions))}
                  />
                </FormField>
